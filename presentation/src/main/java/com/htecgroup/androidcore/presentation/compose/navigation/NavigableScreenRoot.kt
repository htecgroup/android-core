...
import com.htecgroup.androidcore.presentation.compose.CoreScreenRoot

/**
 * Base starting screen extending [CoreScreenRoot] with navigation possibilities.
 */
interface NavigableScreenRoot : CoreScreenRoot {
