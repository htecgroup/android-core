...
import com.htecgroup.core.domain.IResultParamUseCase
import com.htecgroup.coresample.domain.post.Post
import com.htecgroup.coresample.domain.post.PostRepository
import javax.inject.Inject

class UpdatePost @Inject constructor(private val postRepo: PostRepository) :
    CoreUseCase(),
    IResultParamUseCase<Post, Unit> {

    override suspend fun invoke(data: Post) = postRepo.updatePost(data)
}
